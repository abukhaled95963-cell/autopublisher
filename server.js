      ...
      if(mode === 'as-is') {
        ...
        try {
          if(!post.text || post.text.length < 10) {
            ...
            const prompt = isNonArabic
              ? `ترجم النص التالي للعربية الفصحى بالكامل.\n\nقواعد صارمة:\n1. ترجم كل كلمة للعربية بدون استثناء - الروسية والصينية والإنجليزية وغيرها\n2. المصطلحات التقنية مثل FPV تُكتب كما هي لكن اشرحها بالعربية\n3. الأسماء الجغرافية تُترجم أو تُعرّب\n4. لا تذكر المصدر أو الروابط\n5. إذا كان النص إعلاناً أو غير مفيد: أجب بكلمة SKIP فقط\n6. اكتب النص مكتملاً بالعربية\n\nالنص:\n${text}\n\nالترجمة العربية الكاملة:`
